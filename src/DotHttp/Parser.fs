// Implements [HTTP-SHARED], [HTTP-MS], [HTTP-JB], [HTTP-SEPARATOR], [HTTP-METHOD-LINE], [HTTP-HEADERS], [HTTP-BODY], [HTTP-COMMENTS], [HTTP-VARS], [HTTP-CONVERT-PARSE], [HTTP-CONVERT-DETECT], [HTTP-CONVERT-UNSUPPORTED], [HTTP-PARSER-PROJECT]
