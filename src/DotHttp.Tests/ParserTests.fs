...
// Tests [HTTP-SHARED], [HTTP-SEPARATOR], [HTTP-METHOD-LINE], [HTTP-HEADERS], [HTTP-BODY], [HTTP-COMMENTS], [HTTP-VARS], [HTTP-MS], [HTTP-JB], [HTTP-CONVERT-DETECT], [HTTP-CONVERT-PARSE], [HTTP-PARSER-PROJECT], [HTTP-CONVERT-UNSUPPORTED]
