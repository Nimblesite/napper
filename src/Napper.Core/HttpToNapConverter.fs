// Implements [HTTP-CONVERT], [HTTP-CONVERT-MAPPING], [HTTP-CONVERT-ENV], [HTTP-CONVERT-SCRIPTS], [HTTP-CONVERT-OUTPUT], [HTTP-CONVERT-NAMING], [HTTP-CONVERT-OUTDIR], [HTTP-CONVERT-DRYRUN], [HTTP-CONVERT-ENVFILE]
